...
class BookingAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'service', 'equipment', 'start_date', 'end_date', 'duration_type', 'status')
    list_filter = ('duration_type', 'service', 'equipment', 'user', 'status')
    ...
    fieldsets = (
        (None, {
            'fields': ('user', 'service', 'equipment', 'duration_type', 'status')
        }),
        ('Даты', {
    ...
    list_editable = ('status',)  # Добавляем возможность редактирования статуса прямо из списка
